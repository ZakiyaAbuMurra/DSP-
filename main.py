...
def decodefft():
   ...
   for k in range(0,len(samples)//period):
      ...
      m4 = x[-4]
      y1 = y.tolist()
      maximums.append(y1.index(m))

      maximums.append(y1.index(m1))

      maximums.append(y1.index(m3))

      maximums.append(y1.index(m4))
      print(maximums)
      for p  in range(0,len(maximums)):
         maximums[p]*=25
      print(maximums)
      maximums=list(map(int,maximums))
